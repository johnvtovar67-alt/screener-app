...
export function continueC1ActualAccount({adoption,sessions,historySessions,records,cashReconciliations,observedAt}={}) {
  ...
  return {contract:'c1-actual-account-continuation-v1',sourceSessionDate:sessions.at(-1).date,books,sleeves,replay,plans,holdingRankings:sessions.at(-1).accountHoldingRanks||{},holdingPriceHistory,
