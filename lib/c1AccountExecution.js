...
export function replanC1IntradayAccountOpening({adoption,sessions,records,opening,observedAt,completionPolicy,activity,authorityPlan}={}){
  ...
  const continued=continueC1ActualAccount({adoption,sessions,records,observedAt}),actual=reconcileC1ActualAccountFills({plan:activity.plan,fills:activity.fills,observedAt});
...
export function planC1ContinuedAccountOpening({adoption,sessions,records,opening,observedAt,completionPolicy}={}) {
