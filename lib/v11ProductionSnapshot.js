...
export async function getV11ProductionSnapshot({
  ...
  // Explicit preview release candidate: S&P 500, one of the two separately
  // tested universes. Never fall back to the broad cohort under an index label.
  if (process.env.VERCEL_ENV === "preview") {
    try {
      ...
      return assessSnapshot({ ...buildV11ProductionSnapshot(session, now),
        forwardAccounting: { ...view.model, environment: "preview" },
