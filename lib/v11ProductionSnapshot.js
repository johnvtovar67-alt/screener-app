...
// promoted V11 live ranking. The completed compiled checkpoint is immutable
...
export const V11_PRODUCTION_SNAPSHOT_STORE =
  "research/v11-production-snapshot-v1.json";
const COMPILED_CHECKPOINT_STORE =
  "research/fmp-provisional-compiled-checkpoint-v1.json";
const MEMORY_KEY = "__v11ProductionSnapshotCacheV1";
const INFLIGHT_KEY = "__v11ProductionSnapshotInflightV1";
