...
// SOLS and VSNT have historical additions but no corresponding removals, even
// though Nasdaq's own NDX start-of-day weights show each security disappear.
...
export async function runPointInTimeNasdaqUniverse({ force = false } = {}) {
  ...
  const report = {
    ...
    limitations: [
      ...
      "FMP's omitted SOLS and VSNT spin-off removals are completed only on the first official Nasdaq NDX start-of-day weight date where each security is absent.",
