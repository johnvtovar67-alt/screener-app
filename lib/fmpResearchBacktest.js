...
const FMP_RESEARCH_COMPILED_CHUNK_PREFIX =
  "research/fmp-provisional-compiled-v3";
...
async function runProvisionalWindows(
  ...
  const balancedQualityMomentum = {
    ...
    maxVolatility60Pct: 70,
    minReturn120Ex20: 0,
    relativeStrengthRankWeight: 0.2,
    shortTermAlphaRankPenalty: 0.4,
    researchFactorRankWeight: 0.04,
    qualityRankWeight: 0.08,
    sectorQualityRankWeight: 0.04,
    momentumRankWeight: 0.1,
    valueRankWeight: 0.03,
    stabilityRankWeight: 0.05,
    controlledPullbackRankWeight: 0.04,
  ...
  const staticLifecycle = {
    ...
    profitTrailActivationPct: 20,
    profitTrailDistancePct: 12,
  };
  const grid = [
    {
      thesisId: "cash-preservation-control",
      maxPositions: 0,
    },
    {
    ...
    {
      ...balancedQualityMomentum,
      ...staticLifecycle,
      thesisId: "quality-momentum-balanced",
      buyTargetPct: 0.06,
    ...
    },
    {
      ...antiChase,
      ...staticLifecycle,
      thesisId: "quality-at-reasonable-price",
      minimumResearchFactorCoverage: 7,
      minQualityPercentile: 60,
      minMomentumPercentile: 45,
      minCompositePercentile: 55,
      minSectorCompositePercentile: 30,
      maxVolatility60Pct: 55,
      minReturn120Ex20: -2,
      relativeStrengthRankWeight: 0.15,
      shortTermAlphaRankPenalty: 0.35,
      researchFactorRankWeight: 0.04,
      qualityRankWeight: 0.18,
      sectorQualityRankWeight: 0.08,
      momentumRankWeight: 0.06,
      valueRankWeight: 0.12,
      stabilityRankWeight: 0.1,
      controlledPullbackRankWeight: 0.03,
      maxIssuerPositions: 1,
      buyTargetPct: 0.06,
      strongBuyTargetPct: 0.06,
      maxPositions: 10,
    },
    {
      ...antiChase,
      ...staticLifecycle,
      thesisId: "momentum-regime-aware",
      minimumResearchFactorCoverage: 7,
      minQualityPercentile: 35,
      minMomentumPercentile: 70,
      minCompositePercentile: 60,
      minSectorCompositePercentile: 40,
      maxVolatility60Pct: 75,
      minAlpha120VsSpy: 0,
      minReturn120Ex20: 3,
      blockDefensiveEntries: true,
      relativeStrengthRankWeight: 0.3,
      shortTermAlphaRankPenalty: 0.45,
      researchFactorRankWeight: 0.06,
      qualityRankWeight: 0.05,
      sectorQualityRankWeight: 0.03,
      momentumRankWeight: 0.18,
      stabilityRankWeight: 0.02,
      controlledPullbackRankWeight: 0.08,
      relativeExitAlpha20: -5,
      relativeExitMinHoldSessions: 15,
      timeStopSessions: 63,
      maxIssuerPositions: 1,
      buyTargetPct: 0.06,
      strongBuyTargetPct: 0.06,
...
export async function runFmpResearchBacktest({
  ...
  try {
    ...
    const compiledSignature = JSON.stringify({
      ...
      compilerContract: "historical-signal-evaluator-v7-research-v4-chunked",
      statementSignature,
    ...
    const replaySignature = JSON.stringify({
      ...
      thesisContract: "v7-seven-thesis-walk-forward-v4",
      statementSignature,
      finalSymbols: finalSymbols.slice().sort(),
      fromDate,
      endDate,
