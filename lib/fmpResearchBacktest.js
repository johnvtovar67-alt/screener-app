...
function runProvisionalWindows(dataset) {
  ...
  const grid = [
    ...
    {thesisId:"live-compatible-anti-chase",requireRelativeStrength:true,buyTargetPct:0.055,strongBuyTargetPct:0.055,maxPositions:12,maxAlpha20VsSpy:4,minAlpha60VsSpy:-2,minAlpha60VsQqq:-5,relativeStrengthRankWeight:0.75,shortTermAlphaRankPenalty:0.5},
