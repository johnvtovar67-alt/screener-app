...
export function portfolioDecision({stock={},recommendation={},position={}}={}){
  ...
  // Stabilization is not a Buy signal. It only prevents a premature Exit while a weak swing is trying to turn.
  // Require several improving/constructive observations so one green day cannot rescue a broken trade.
  ...
  return{action,role,capitalPriority,expertDecision:expert,reason,exitConfirmation:{confirmed:role==='Swing'?swingExitConfirmed:action==='Exit',marketTechnicalBroken,thesisBroken,riskBroken,severeTradeBreak,independentFamilyCount,stabilizationPending,stabilizationSignals}};
}
