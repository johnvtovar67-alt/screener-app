...
export function expertGates(stock={},recommendation={}){
  ...
  // Broad-screen fresh capital requires an explicitly verified fundamental row.
  // "deferred" is a feed-budget state, not evidence of business quality, and must
  // never slip through as deployable merely because it is not named "unavailable".
  const fundamentalsPass=fundamentalStatus==='complete'||fundamentalStatus==='legacy';
