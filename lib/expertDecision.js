...
export function expertGates(stock={},recommendation={}){
  ...
  const strongRewardRiskQuality=rr===0?55:clamp(50+((rr-1.5)/1.0)*50,0,100);
  ...
  const strongSafetyPass=fundamentalsPass&&quote.pass&&trendPass&&volumePass&&participationPass&&!chase&&(rr===0||rr>=1.50);
