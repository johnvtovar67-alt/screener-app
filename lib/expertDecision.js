...
export function portfolioDecision({stock={},recommendation={},position={}}={}){
  ...
  if(merger.active){
    ...
    else if(profitProtection){action='Trim';reason=winnerFading?'This has been a successful trade, but momentum/setup quality is fading. Bank part of the gain rather than waiting for a full breakdown.':healthyWinner?'This has been a successful trade and is extended, but the trend and setup remain healthy. Protect some profit without over-cutting the position while it is still working.':highFroth?'This has been a successful trade and the position is now materially extended. Bank part of the gain while keeping meaningful exposure.':'This winner is becoming stretched after a large gain. Take partial profits while allowing the remaining position to keep working.';}
