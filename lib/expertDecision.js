...
export function portfolioDecision({stock={},recommendation={},position={}}={}){
  ...
  if(role==='Core'){
    ...
    else if(rotationCandidate){action='Rotate';reason=`The swing remains viable, but ${rotateTarget} is a current Buy with a materially stronger forward setup. Rotate rather than let a weak swing become dead money.`;}
