...
import { compileC1LiveInput, c1LiveMembers, C1_LIVE_UNIVERSES, buildC1PriorSessionPrices } from './c1LiveInput';
...
export async function collectC1LiveInput({ universe = 'nasdaq', now = new Date(), fetcher = fetch,
  ...
  return { ...input, priorSessionPrices, sourceReceipt: { provider: 'FMP', membershipEndpoint: spec.endpoint,
