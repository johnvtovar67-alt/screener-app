...
export function calcExpectationRisk(row = {}) {
  ...
  if (pctFrom50 != null) {
    ...
    else if (pctFrom50 > 25) risk += 22;
    else if (pctFrom50 > 18) risk += 14;
  }

  if (pctFrom200 != null) {
    if (pctFrom200 > 150) risk += 28;
    else if (pctFrom200 > 100) risk += 20;
    else if (pctFrom200 > 70) risk += 12;
  }

  if (day != null && day > 12) risk += 18;
  else if (day != null && day > 8) risk += 12;

  if (rv != null && rv > 3.5 && pctFrom50 != null && pctFrom50 > 20) risk += 12;
...
export function getThemeMaturity(row = {}) {
  ...
  if (
    ...
    (pctFrom200 != null && pctFrom200 > 100) ||
    (pe != null && pe > 120)
  ) {
    return "Crowded Momentum";
  }

  if (momentumScore >= 75 && expectationRisk >= 30) {
...
export function getSetupGrade(row = {}) {
  ...
  if (expectationRisk >= 55 || !above50 || momentum < 55) {
    return "C";
  }
...
export function getRecommendation(row = {}) {
  ...
  const buyNowCandidate = fullAlignmentBuyNow || momentumTriggerBuyNow;
