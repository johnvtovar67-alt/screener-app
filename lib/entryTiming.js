...
export function applyEntryTimingGate(stock={},timing=null,now=new Date()){
  ...
  const timingBlocked=!t.available||!t.pass,blocked=timingBlocked||!liquidityPass,blockReason=timingBlocked?t.reason:liquidityReason;
