...
export function c1ModelEventPhase(trade){
 ...
 if(['rank-deterioration','early-rank-deterioration','profit-rank-deterioration','relative-strength-break','trend-relative-break','time-stop','bounded-review-expiry','exit','reduce','trim'].includes(trade.reason))return 1;
