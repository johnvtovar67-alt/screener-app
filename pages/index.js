...
export default function Home(){
  ...
  return <main>
    ...
    {tab!=="account-tools"&&<footer className="accountSettingsLink"><button onClick={()=>setTab("account-tools")}>Account settings</button></footer>}
