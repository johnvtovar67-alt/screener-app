...
export default function Home(){
  ...
  function trimFraction(s,d){const pp=d?.profitProtection||{},pnl=Number.isFinite(+pp.pnlPct)?+pp.pnlPct:(+s.gainLossPct||0);if(pp.extremeFroth||(pp.winnerFading&&pnl>=60))return{pct:.45,label:"High"};if(pp.winnerFading||pp.moderateFroth||pnl>=75)return{pct:.35,label:"Elevated"};return{pct:.25,label:"Moderate"};}
