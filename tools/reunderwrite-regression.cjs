...
assert(r.override&&r.action==='Review'&&/chart confirmation is not supportive/.test(r.reason),'A portfolio holding with failed historical timing must not be described as technically supportive');
