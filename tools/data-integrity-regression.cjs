...
assert(snapshotStore.includes('snapshotId: [')&&snapshotStore.includes('sessionDates.at(-1)')&&snapshotStore.includes('latestChunk.lastDate')&&snapshotStore.includes('latestChunk.end, -1) !== sessionDates.length')&&snapshotStore.includes('datasetThrough !== requiredSessionDate')&&snapshotStore.includes('candidatesValid'),'C1 snapshots must bind to the exact current compiled manifest, chunk, and dataset and pass structural candidate validation');
