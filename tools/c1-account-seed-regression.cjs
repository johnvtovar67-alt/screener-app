...
assert.ok(riskReason.includes('Ranking is unavailable for this holding in the current feed'));
...
(async()=>{
 ...
 assert.equal(inheritedView.positions[0].action,'Ranking unavailable');
