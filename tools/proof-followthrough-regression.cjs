...
s=stock(18,-11,{trade:72,technical:66,momentum:62,leadership:63,capital:72});t=swingTimeReview(s);r=reunderwriteExistingPosition({stock:s,decision:{action:'Hold'},risk,timeReview:t});assert(r.action==='Hold'&&/immediate Proof review/i.test(r.reason),'double-digit Proof loss with unusually strong forward evidence must not remain an ordinary Hold');
